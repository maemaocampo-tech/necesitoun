  ...
  return (
    <div className="mt-2">
      ...
      <div
        ...
        style={{
          backgroundColor: anunciante.color,
        ...
        {anunciantes.map((_, i) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all ${
              i === actual ? "bg-blue-500 w-4" : "bg-gray-300"
            }`}
          />
        ))}
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-6">
          <div className="bg-white rounded-2xl p-6 shadow-xl w-full max-w-sm text-center">
            ...
            <p className="text-gray-600 mt-3 text-sm leading-relaxed">
              Comunicate con nosotros para gestionar tu espacio publicitario.
            </p>

            <a
              href="https://wa.me/541168056785"
              target="_blank"
              rel="noopener noreferrer"
              className="block mt-5 bg-green-500 hover:bg-green-600 transition text-white text-center rounded-xl py-3 font-bold"
            >
              WhatsApp
            </a>
            ...
            <button
              ...
              className="block w-full mt-3 text-center text-gray-400 text-sm py-2"
            >
              Cerrar
            </button>
